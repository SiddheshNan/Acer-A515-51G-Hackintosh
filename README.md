...
Consider switching over to [OpenCore Bootloader](https://github.com/SiddheshNan/Acer-A515-51G-Hackintosh-OpenCore) as it provides much better performance improvements over Clover Bootloader
